 ...
 * @param schema Optional Zod schema, if undefined validation is not performed
 * @returns a "promise" to produce a 2-d array of cell values, or an array of type T
 */
